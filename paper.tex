...
devised to characterize molecular shape. For example, the ``shape
signature'' approach described by Zauhar et al \cite{Zauhar:2003fk} is a novel application of a
ray tracing method that generates a description of the molecular
...
pre-defined points. As a result, the calculation procedure is
extremely fast and once calculated shape similarities can be evaluated
rapidly via a simple distance calculation. 
\textbf{
  spherical harmonic shape descriptors, field based descriptors
  [Cresset etc]}
