...
easily generate descriptors from multiple sources~\cite{Truszkowski2011}. Given the focus of
...
reproducibility in studies that employ molecular descriptors, some form
